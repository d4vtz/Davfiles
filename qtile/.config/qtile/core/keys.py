...
import os
from utils.functions import resize_down, resize_left, resize_right, resize_up, backlight 
...
keys = [
    ...
    # menus
    Key([mod, shift], "Return", lazy.spawn("rofi -show drun -theme ~/.config/rofi/launcher.rasi"), desc="Launch Rofi"),
